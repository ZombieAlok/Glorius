			...
			if(isset($_POST['form_subscribe']))
			{
			    ...
			    else
			    {
				    ...
				    else
				    {
				    	...
				    	{
				    		// Enviar correo para confirmar suscripción
							...
							$subject = 'Confirmación de suscripción - SSDTech';
							
							// Creación del enlace de confirmación
							$verification_url = BASE_URL.'verify.php?email='.$to.'&key='.$key;

							$message = '
Gracias por suscribirte a nuestro boletín<br><br>
Por favor, confirma tu suscripción:
					'.$verification_url.'<br><br>
El link sólo será válido durante 24 horas.
					';
							...
							// Llamado a la función mail para completar el correo
...
<script>
	...
	{
	    return confirm("¿Estás seguro de que quieres eliminar esta información?");
	}
