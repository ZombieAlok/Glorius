...
if(!isset($_REQUEST['id'])) {
    ...
    // Verificar si el ID es válido o no
...
//Obtener los IDs y nombres de la categoría y subcategorías del producto
...
// Calificación media del producto
$t_rating = 0;
...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Este producto ya está en el carrito.';
        } else {
            ...
            $success_message1 = 'Producto añadido al carrito con éxito!';
        }
    ...
    else
    {
        ...
        $success_message1 = 'Se ha añadido un producto a tu carrito.';
    }
	endif;
}
?>
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="btn-cart btn-cart1">
                                <input type="submit" value="<?php echo LANG_VALUE_164; ?>" name="form_add_to_cart">
							</div>
                            </form>
						</div>
					</div>
