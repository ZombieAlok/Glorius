    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Se obtienen los datos de facturación del cliente desde la tabla customer -->
                ...
                <div class="row">
                    <!-- Si los usuarios tienen su información completa, pueden proceder -->
                    	<?php
		                $checkout_access = 1;
		                if(
		                ...
		                ?>
                        <!-- Si los usuarios no tienen su información de envío y facturación completas, no pueden proceder -->
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        Debes haber completado tu información de envío y de facturación en tu panel de cuenta para poder comprar. Por favor, <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">completa la información</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
