...
// Se obtienen los datos de texto de los títulos y secciones de la página principal
{
...
<!-- Servicios ofrecidos por la página -->
<?php if($home_service_on_off == 0): ?>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i> Ver producto</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
...
<?php if($home_latest_product_on_off == 0): ?>
