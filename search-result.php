...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            $limit = 12;                                 //Cuántos artículos mostrar por página
            $page = @$_GET['page'];
            if($page) 
                $start = ($page - 1) * $limit;          //El primer artículo a mostrar
            else
                $start = 0;
            ...
            if ($page == 0) $page = 1;                  //Página 1 por defecto
            $prev = $page - 1;                          //Página anterior es la variable page - 1
            $next = $page + 1;                          //Página siguiente es la variable page + 1
            $lastpage = ceil($total_pages/$limit);      //La última página = total de páginas / items por página, redondeado.
            $lpm1 = $lastpage - 1;   
            $pagination = "";
            if($lastpage > 1)
            {   
                ...
                if ($lastpage < 7 + ($adjacents * 2))   //Si no hay suficientes páginas, no se resume
                {   
                ...
                elseif($lastpage > 5 + ($adjacents * 2))    //Resumir si hay varias páginas
                {
                                ...
                                <div class="col-md-3 item item-search-result">
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                            ...
                                            <?php else: ?>
                                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>">Ver producto</a></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
