<!-- Archivo de la configuración principal -->
<?php
ob_start();
session_start();
?>
<!-- Se incluyen los archivos PHP de configuración de BD, funciones y protección CSRF -->
<?php
...
// Obteniendo las variables de lenguaje
$i=1;
...
// Revisión de la tabla de pedidos para eliminar los que sigan pendientes después de 24h de haber sido creados
...
foreach ($result as $row) {
	...
	if($time>24) {
		...
		// Eliminación de los pedidos purgados
...
<head>
	...
	if($cur_page == 'customer-billing-shipping-update.php') {
		?>
		<title>Actualizar información de envío y facturación - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
